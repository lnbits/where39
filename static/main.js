...
if (paracode >= 1 && paracode <= 9999999) {
  ...
  var attrib =
    '<button id="inputbox" onclick="_mylocation()">My location</button><br/><form onsubmit="_zoomTo(); return false"><input type="text" name="lng" id="inp" placeholder="Enter four bip39 words" style="width:70%"><input style="width:30%" type="submit" value="submit"></form><div><b style="color:red;width:70%;float:left;" >Word-list shuffled using ' +
    paracode +
    '</b><a href="' +
    url +
...
const split64seed = chunkArray(fullseed, 64);
const split45seed = chunkArray(p45seed, 45);
const split20seed = chunkArray(p20seed, 20);

const tilesizes = [5.625, 0.125, 0.00277777777, 0.00006172839, 0.00000308642];
const tileseeds = [
  split64seed,
  split45seed,
  split45seed,
